...
module precision
  integer, parameter   :: stdout=6                     ! use standard value for stdout file number 
  integer, parameter   :: stderr=0                     ! use standard value for stderr file number 
  integer, parameter   :: sint=selected_int_kind(9)    ! integers up to 10^9 usually 4 byte (MPI_INTEGER4)
  integer, parameter   :: lint=selected_int_kind(18)   ! integers up to 10^19 usually 8 byte (MPI_INTEGER8) 
